    ...
    <v-layout wrap>
      ...
      <v-flex xs12 md6 lg6>
        <v-list three-line>
          ...
          <v-list-item href="https://cylc.github.io/cylc-doc/latest/html/workflow-design-guide/index.html" target="_blank">
            <v-list-item-avatar size="60" style="font-size: 2em;">
          ...
          <!-- TODO: change from latest to stable once out of beta -->
          <v-list-item href="https://cylc.github.io/cylc-doc/latest/html/index.html" target="_blank">
            <v-list-item-avatar size="60" style="font-size: 2em;">
